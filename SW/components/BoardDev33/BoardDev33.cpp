...
BoardDev33::BoardDev33(void) : Board()
{
    //
}

BoardDev33::~BoardDev33(void)
{
    //
}

esp_err_t BoardDev33::EarlyInit(void)
{
    gpio_config_t gc;
...
esp_err_t BoardDev33::CriticalInit(void)
{
    return ESP_OK;
}

esp_err_t BoardDev33::BoardInit(void)
{
    return ESP_OK;
}

void BoardDev33::PowerOn(void)
{
    gpio_set_level(GPIO_Power, 1);
}

void BoardDev33::PowerOff(void)
{
    gpio_set_level(GPIO_Power, 0);
}

bool BoardDev33::OnboardButtonPressed(void)
{
